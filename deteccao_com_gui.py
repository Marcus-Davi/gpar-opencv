...
cv2.createTrackbar('S',txt_inf,50,255,nothing)
cv2.createTrackbar('V',txt_inf,50,255,nothing)
...
cv2.createTrackbar('Par1',txt_ft,0,100,nothing)
cv2.createTrackbar('Raio_max',txt_ft,50,100,nothing)
cv2.createTrackbar('Raio_min',txt_ft,0,100,nothing)
cv2.createTrackbar('Raio_max',txt_ft,50,100,nothing)
...
##################################################################### 
    ...
    if denoise_sw == 0:
        ...
        img_denoised = cv2.fastNlMeansDenoisingColored(img_orig,None,10,10,7,denoise_sw)      
        result = img_denoised  
    ...
    if dilation_sw == 0:
        ...
        result = cv2.dilate(result, kernel_dil, iterations=1)
        dilation = result
    ...
    if detected_circles is not None:
        ...
        for pt in detected_circles[0, :]:
            ...
            cv2.circle(img_orig, (a, b), 1, (0, 0, 255), 3)
